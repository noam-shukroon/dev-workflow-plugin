...
4. **Session scope check.** Split if: 8+ tasks, 3+ batches with visual verification, or 4+ unrelated areas.
...
5. Present plan to user. Execute on approval.
...
3. **Parallel subagents** for steps 3a-3d (different files):
